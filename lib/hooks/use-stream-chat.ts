...
import { streamChat } from '../../app/actions/consultation';
...
export function useStreamChat({
  ...
  onMessageComplete,
  onError,
  useDify = false, // 默认禁用Dify，因为本地RAG服务不包含此端点
  knowledgeBase = 'managconsult',
  ...
  }, [sessionId, isStreaming, onMessageComplete, onError, useDify, knowledgeBase]);
